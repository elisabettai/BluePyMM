...
def get_parser():
    ...
    select_combos.add_parser_dep(actions)
...
def run(arg_list):
    ...
    if args.action == "prepare":
        ...
        select_combos.select_combos(conf_filename=args.conf_filename, n_processes=args.n_processes)

    elif args.action == "select_dep":
        select_combos.select_combos_dep(conf_filename=args.conf_filename, n_processes=args.n_processes)
